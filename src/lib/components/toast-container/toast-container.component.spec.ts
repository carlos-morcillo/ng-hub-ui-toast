...
import { HubToastContainerComponent } from './toast-container.component';
 ...
 */
describe('HubToastContainerComponent', () => {
	let fixture: ComponentFixture<HubToastContainerComponent>;
	...
	beforeEach(() => {
		...
		fixture = TestBed.createComponent(HubToastContainerComponent);
	});
